...
require (
	...
	github.com/fluxcd/kustomize-controller v0.0.0-00010101000000-000000000000
...
replace github.com/fluxcd/kustomize-controller => /Users/bkreitch/github/bkreitch/kustomize-controller
